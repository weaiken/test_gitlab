...
-- ----------------------------
-- Table structure for paper_store
-- ----------------------------
DROP TABLE IF EXISTS `paper_store`;
...
-- ----------------------------
-- Table structure for ques_bank_store
-- ----------------------------
DROP TABLE IF EXISTS `ques_bank_store`;
