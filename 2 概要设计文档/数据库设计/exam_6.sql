...
CREATE TABLE `examinee`  (
  ...
  `uid` int(50) NULL DEFAULT NULL COMMENT '与已注册的考生信息关联',
...
CREATE TABLE `examinee_ans`  (
  ...
  `eid` int(50) NOT NULL COMMENT '参加考试的考生',
  `pqid` int(50) NOT NULL COMMENT '成绩报告id',
...
CREATE TABLE `paper`  (
  ...
  `describe` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '试卷描述',
...
CREATE TABLE `ques_bank`  (
  ...
  `qsi_num` int(50) NOT NULL COMMENT '单选题数量',
  `qm_num` int(50) NOT NULL COMMENT '多选题数量',
  `qtf_num` int(50) NOT NULL COMMENT '判断题数量',
  `qf_num` int(50) NOT NULL COMMENT '填空题数量',
  `qsh_num` int(50) NOT NULL COMMENT '简答题数量',
